...
<center style="width: 100%; background-color: #fff;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
      	<tr>
          <td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em; background-color: #fff;">
	      ...
	      <tr>
          <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0; background-color: #fff;
position: relative;
z-index: 0;">
            <img src="images/email.png" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
				...
				<tr>
          <td valign="middle" class="hero bg_white" style="padding: 2em 0 4em 0; background-color: #fff;
position: relative;
z-index: 0;">
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;color: rgba(0,0,0,.3);">
            				<h2 style="color: #000;
font-size: 40px;
margin-bottom: 0;
font-weight: 400;
line-height: 1.4;">Welcome!</h2>
            				<h3 style="
font-size: 24px;
font-weight: 300;">
                                Dear
...
border-radius: 5px;
background: #754668;
color: #ffffff;" class="btn btn-primary">Take me there</a>. You can also set a password in order to protect your account.
                                @else
                                    You can keep track of all of your quotes and activity from your dashboard. <a href="{{ url('MyAccount') }}" style="
	padding: 10px 15px;
	display: inline-block;
border-radius: 5px;
background: #754668;
color: #ffffff;" class="btn btn-primary">Take me there</a>.
                                @endif
                            </p>
            			</div>
            		</td>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; background-color: rgba(0,0,0,.15);">
      	<tr>
